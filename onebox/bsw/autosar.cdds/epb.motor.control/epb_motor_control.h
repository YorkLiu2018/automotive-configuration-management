/**
 *******************************************************************************
 * @file      epb_motor_control.h
 * @brief     EPB 电机控制驱动模块接口声明
 * @version   1.0.0
 * @date      2026-08-17
 ...
 *******************************************************************************
 */
#ifndef EPB_MOTOR_CONTROL_H
#define EPB_MOTOR_CONTROL_H
...
/* ==================== 版本信息 ==================== */
#define EPB_MOTOR_CONTROL_VERSION_STRING   "1.0.0"

/* ==================== 宏定义 ==================== */
/* TODO: 在此添加模块相关宏定义（如占空比限值等） */

/* ==================== 类型定义 ==================== */
/* TODO: 在此添加模块相关类型定义（如电机状态枚举等） */
