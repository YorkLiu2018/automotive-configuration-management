/**
 *******************************************************************************
 * @file      autosar_static.h
 * @brief     AUTOSAR 静态代码模块接口声明
 * @version   1.0.0
 * @date      2026-08-17
 ...
 *******************************************************************************
 */
#ifndef AUTOSAR_STATIC_H
#define AUTOSAR_STATIC_H
...
/* ==================== 版本信息 ==================== */
#define AUTOSAR_STATIC_VERSION_STRING   "1.0.0"
